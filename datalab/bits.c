...
unsigned floatPower2(int x) {
  // E = 1 - bias for denorm 2 ^ -149 (-23 + -126) to 2 ^ -126(2^-1 + .. + 2^-23)
  // norm 2 ^ -126 to 2 ^127(E = 11111110 / 254 -127)
  if (x < -149){
    return 0;
  }else if (x < -126)
  {// E = x
